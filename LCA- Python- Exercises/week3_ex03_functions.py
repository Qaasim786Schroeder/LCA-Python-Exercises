...
# TODO: Define a function called 'rectangle_area' that takes length and width as parameters 
...
# TODO: Define a function called 'apply_operation' that takes a function and a number 
# as parameters, and returns the result of applying the function to the number
...
print(f"Applying 'double' to 7: {result_double}")

# TODO: Use the 'apply_operation' function with the 'square' function and the number 3, and print the result
result_op_square = apply_operation(square, 3)
print(f"Applying 'square' to 3: {result_op_square}")